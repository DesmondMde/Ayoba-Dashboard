...
<script>
    ...
    xhr.open('GET', 'https://efb30d56.ngrok.io/api/menus/'+menuId+'/items', true)
    xhr.onload = function()
        {
            if (this.status === 200)
                {
                  ...
                  var arrItems = [];
                    $.each(data, function (index, value) {
                       // alert(value.name);
                       d1.insertAdjacentHTML('beforeend',  "<tr><td>"+value.title+"</td><td>"+value.description+"</td><td> R"+value.price+"</td></tr>" );
                    });
                 //
                 //
                 }
